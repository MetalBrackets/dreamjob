...
export const translations = {
  ...
  fr: {
    ...
    selectedOffer: {
      ...
      resumeSkillsTitle: 'Competences mises en avant',
      resumeExperienceTitle: 'Experience selectionnee',
      resumeEducationTitle: 'Formation',
      resumeKeywordsTitle: 'Mots-cles couverts',
      resumeNotesTitle: 'Notes de generation',
      resumeOmittedTitle: 'Elements omis',
    ...
    dashboard: {
      ...
      score: 'Score',
      actions: 'Actions',
      noFollowUp: 'Aucune relance pr�vue',
      followUpNow: 'Action � faire maintenant',
      followUpSoon: 'Action � faire bient�t',
      followUpLater: '� venir',
